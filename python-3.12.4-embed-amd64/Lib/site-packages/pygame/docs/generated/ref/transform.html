...
<html lang="en" data-content_root="../">
  <head>
    ...
    <title>pygame.transform &#8212; pygame-ce v2.5.0 documentation</title>
...
<tr class="row-even"><td><div class="line"><a class="toc reference external" href="transform.html#pygame.transform.hsl">pygame.transform.hsl</a></div>
</td>
<td>—</td>
...
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in pygame-ce 2.4.0: </span>Adjusted formula slightly to support performance optimisation. It may return very slightly
different pixels than before, but should run seven to eleven times faster on most systems.</p>
</div>
</dd></dl>
...
<div class="line"><span class="signature">hsl(surface, hue, saturation, lightness, dest_surface=None) -&gt; Surface</span></div>
</div>
