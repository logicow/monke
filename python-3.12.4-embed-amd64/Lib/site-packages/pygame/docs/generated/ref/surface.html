...
<html lang="en" data-content_root="../">
  <head>
    ...
    <title>pygame.Surface &#8212; pygame-ce v2.5.0 documentation</title>
    <link rel="stylesheet" type="text/css" href="../_static/pygments.css?v=fa44fd50" />
    <link rel="stylesheet" type="text/css" href="../_static/pygame.css?v=ea7ab853" />
...
If it has transparency, transparent pixels will be ignored when blittting to an 8-bit <code class="docutils literal notranslate"><span class="pre">Surface</span></code>.</p>
</dd>
</dl>
</li>
<li><dl class="simple">
<dt><code class="docutils literal notranslate"><span class="pre">dest</span></code></dt><dd><p>The <code class="docutils literal notranslate"><span class="pre">source</span></code> draw position onto this <code class="docutils literal notranslate"><span class="pre">Surface</span></code>.
It can be a coordinate <code class="docutils literal notranslate"><span class="pre">(x,</span> <span class="pre">y)</span></code> or a <code class="docutils literal notranslate"><span class="pre">Rect</span></code> (using its top-left corner).
...
<div class="line"><span class="signature">blits(blit_sequence=((source, dest), ...), doreturn=True) -&gt; [Rect, ...] or None</span></div>
...
<li><p>Prefer using <a class="reference internal" href="#pygame.Surface.blits" title="pygame.Surface.blits"><code class="xref py py-meth docutils literal notranslate"><span class="pre">blits()</span></code></a> over <a class="reference internal" href="#pygame.Surface.blit" title="pygame.Surface.blit"><code class="xref py py-meth docutils literal notranslate"><span class="pre">blit()</span></code></a> when drawing a multiple images
for better performance. Use <a class="reference internal" href="#pygame.Surface.blit" title="pygame.Surface.blit"><code class="xref py py-meth docutils literal notranslate"><span class="pre">blit()</span></code></a> if you need to draw a single image.</p></li>
...
<p><span class="versionmodified changed">Changed in pygame-ce 2.5.0: </span>converting to a known format will succeed without a window/display surface.</p>
</div>
</dd></dl>
...
<p>Return the width and height of the Surface in pixels. Can also be accessed with <a class="reference internal" href="#pygame.Surface.size" title="pygame.Surface.size"><code class="xref py py-attr docutils literal notranslate"><span class="pre">size</span></code></a></p>
</dd></dl>
...
<p>It is worth noting that after calling this method, methods that return the color of a pixel
...
the original 255 from just the two remaining zeros in the color and alpha channels).</p>
<p>If you call this method, and then call it again, it will multiply the color channels by the alpha channel
...
surfaces contain pre-multiplied alpha colors.</p>
<p>There is a <a class="reference external" href="tutorials/en/premultiplied-alpha">tutorial on premultiplied alpha blending here.</a></p>
<div class="versionadded">
<p><span class="versionmodified added">New in pygame-ce 2.1.4.</span></p>
</div>
</dd></dl>
...
<span class="sig-name descname"><span class="pre">width</span></span><a class="headerlink" href="#pygame.Surface.width" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
...
<span class="sig-name descname"><span class="pre">height</span></span><a class="headerlink" href="#pygame.Surface.height" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
...
<span class="sig-name descname"><span class="pre">size</span></span><a class="headerlink" href="#pygame.Surface.size" title="Link to this definition">¶</a></dt>
<dd><div class="line-block">
<div class="line"><span class="summaryline">Surface size in pixels (read-only)</span></div>
<div class="line"><span class="signature">height -&gt; tuple[int, int]</span></div>
</div>
...
<a href="https://github.com/pygame-community/pygame-ce/edit/main/docs/reST/ref\surface.rst" rel="nofollow">Edit on GitHub</a>
    ...
    <div class="related" role="navigation" aria-label="related navigation">
      ...
      <ul>
        ...
        <li class="nav-item nav-item-0"><a href="../index.html">pygame-ce v2.5.0 documentation</a> &#187;</li>
