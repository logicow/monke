...
<html lang="en" data-content_root="../">
  <head>
    ...
    <title>pygame.display &#8212; pygame-ce v2.5.0 documentation</title>
...
<div class="versionadded">
<p><span class="versionmodified added">New in pygame-ce 2.0.0: </span><code class="docutils literal notranslate"><span class="pre">vsync</span></code> parameter</p>
</div>
...
to update.</p>
<p>If passing a sequence of rectangles it is safe to include None
...
<div class="line"><span class="signature">get_window_position() -&gt; tuple</span></div>
</div>
...
The position will change when the user moves the window or when the position is set manually with <a class="tooltip reference internal" href="#pygame.display.set_window_position" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.display.set_window_position()</span></code><span class="tooltip-content">Set the current window position</span></a>.
Coordinates could be negative or outside the desktop size bounds.
The position is relative to the topleft of the primary monitor and the y coordinate ignores the window frame.</p>
</dd></dl>
...
<div class="line"><span class="signature">set_window_position((x, y)) -&gt; None</span></div>
</div>
...
The user will still be able to move the window after this call. See also <a class="tooltip reference internal" href="#pygame.display.get_window_position" title=""><code class="xref py py-func docutils literal notranslate"><span class="pre">pygame.display.get_window_position()</span></code><span class="tooltip-content">Return the position of the window or screen</span></a>.</p>
</dd></dl>
...
<dd class="field-odd"><p>The index of the button that was pushed.</p>
</dd>
</dl>
