...
<html lang="en" data-content_root="../">
  <head>
    ...
    <title>pygame.math &#8212; pygame-ce v2.5.0 documentation</title>
...
If <code class="docutils literal notranslate"><span class="pre">do_clamp</span></code> is false, the result can exceed the range 0.0 to 1.0.</p>
<p>The formula is:</p>
<p><code class="docutils literal notranslate"><span class="pre">a</span> <span class="pre">*</span> <span class="pre">value</span> <span class="pre">+</span> <span class="pre">(1</span> <span class="pre">-</span> <span class="pre">value)</span> <span class="pre">*</span> <span class="pre">b</span></code>.</p>
<div class="versionadded">
...
<div class="highlight-python notranslate"><div class="highlight"><pre><span></span><span class="o">&gt;</span> <span class="n">a</span> <span class="o">=</span> <span class="mi">10</span>
<span class="o">&gt;</span> <span class="n">b</span> <span class="o">=</span> <span class="mi">20</span>
<span class="o">&gt;</span> <span class="n">pygame</span><span class="o">.</span><span class="n">math</span><span class="o">.</span><span class="n">invlerp</span><span class="p">(</span><span class="mi">10</span><span class="p">,</span> <span class="mi">20</span><span class="p">,</span> <span class="mf">11.5</span><span class="p">)</span>
<span class="o">&gt;</span> <span class="mf">0.15</span>
<span class="o">&gt;</span> <span class="n">pygame</span><span class="o">.</span><span class="n">math</span><span class="o">.</span><span class="n">lerp</span><span class="p">(</span><span class="mi">10</span><span class="p">,</span> <span class="mi">20</span><span class="p">,</span> <span class="mf">0.15</span><span class="p">)</span>
<span class="o">&gt;</span> <span class="mf">11.5</span>
</pre></div>
</div>
<div class="versionadded">
...
<code class="docutils literal notranslate"><span class="pre">b</span></code> the result is going to be.</p>
<p>The formula is:</p>
<p><code class="docutils literal notranslate"><span class="pre">a</span> <span class="pre">*</span> <span class="pre">interp</span> <span class="pre">+</span> <span class="pre">(1</span> <span class="pre">-</span> <span class="pre">interp)</span> <span class="pre">*</span> <span class="pre">b</span></code></p>
<p>where:</p>
...
<div class="line"><span class="signature">smoothstep(Vector2, float, /) -&gt; Vector2</span></div>
</div>
...
change happening more slowly near the limits (0.0 and 1.0) and faster in the middle.
The third parameter determines how far between the two vectors the result is going to be.</p>
<p>The formula is:</p>
<p><code class="docutils literal notranslate"><span class="pre">a</span> <span class="pre">*</span> <span class="pre">interp</span> <span class="pre">+</span> <span class="pre">(1</span> <span class="pre">-</span> <span class="pre">interp)</span> <span class="pre">*</span> <span class="pre">b</span></code></p>
<p>where:</p>
<p><code class="docutils literal notranslate"><span class="pre">interp</span> <span class="pre">=</span> <span class="pre">value</span> <span class="pre">*</span> <span class="pre">value</span> <span class="pre">*</span> <span class="pre">(3</span> <span class="pre">-</span> <span class="pre">2</span> <span class="pre">*</span> <span class="pre">value)</span></code></p>
...
<a class="reference external" href="https://github.com/pygame-community/pygame-ce">Please leave clamp_magnitude feedback with authors</a></p>
...
<dd><div class="line-block">
<div class="line"><span class="summaryline">returns a smooth interpolation to the given vector.</span></div>
<div class="line"><span class="signature">smoothstep(Vector3, float, /) -&gt; Vector3</span></div>
</div>
<p>Returns a Vector which is a smooth interpolation between self and the
given Vector. This means that the interpolation follows an s-shaped curve, with
change happening more slowly near the limits (0.0 and 1.0) and faster in the middle.
