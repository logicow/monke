...
<html lang="en" data-content_root="../">
  <head>
    ...
    <title>pygame.Rect &#8212; pygame-ce v2.5.0 documentation</title>
...
<p>Returns a new rectangle that is moved to the given position. You must provide keyword
arguments to the method such as <code class="docutils literal notranslate"><span class="pre">center</span></code>, <code class="docutils literal notranslate"><span class="pre">left</span></code>, <code class="docutils literal notranslate"><span class="pre">midbottom</span></code> that correspond
to the rectangle's attributes and the method will return a new rectangle whose specified
attributes are set to the given value.</p>
